...
**Step 2:** Double-click `install.bat` and it will:
 - ✓ Download the latest release (Zip with DLLs)
 - ✓ Install everything you need
...
After installation, Scribble can be updated by re-running the installer.
(Automatic updates are planned for a future version).
